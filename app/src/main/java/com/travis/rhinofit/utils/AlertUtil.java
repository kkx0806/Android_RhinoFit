...
public class AlertUtil {
    ...
    public static void errorAlert(Context ctx) {
        showAlertDialog(MESSAGE_ALERT, ctx, "Error", "Request failure", null, "OK");
    }
    ...
    public static void messageAlert(Context ctx, String title, String message, DialogInterface.OnClickListener callBack) {
        showAlertDialog(MESSAGE_ALERT, ctx, title, message, callBack, "OK");
    }
